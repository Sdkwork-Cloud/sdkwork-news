...
This directory is the local SDKWork component contract for `sdkwork-content-news-service`.

- Component root: `sdkwork-news/crates/sdkwork-content-news-service`
