...
#[tokio::test]
async fn validate_feed_query_requires_tenant_id() {
...
#[tokio::test]
async fn validate_feed_query_limit_zero_fails() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
    let query = FeedQuery {
...
#[tokio::test]
async fn validate_feed_query_limit_over_100_fails() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
    let query = FeedQuery {
        tenant_id: "100001".to_string(),
...
#[tokio::test]
async fn validate_feed_query_valid_passes() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
    let query = FeedQuery {
        tenant_id: "100001".to_string(),
...
#[tokio::test]
async fn validate_share_event_requires_tenant_id() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
...
#[tokio::test]
async fn validate_share_event_requires_item_id() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
    let cmd = ShareEventCommand {
        tenant_id: "100001".to_string(),
...
#[tokio::test]
async fn validate_share_event_valid_passes() {
    let repo = test_helpers::create_test_repo().await;
    let service = NewsFeedPersonalizationService::new(repo);
    let cmd = ShareEventCommand {
        tenant_id: "100001".to_string(),
...
#[tokio::test]
async fn compute_next_cursor_returns_cursor_when_at_limit() {
...
#[tokio::test]
async fn compute_next_cursor_returns_none_when_below_limit() {
    use sdkwork_content_news_service::service::feed_personalization_service::FeedItem;
...
#[tokio::test]
async fn compute_next_cursor_returns_none_for_empty() {
    let items = vec![];
    let cursor = NewsFeedPersonalizationService::compute_next_cursor(&items, 10);
    assert_eq!(cursor, None);
}
