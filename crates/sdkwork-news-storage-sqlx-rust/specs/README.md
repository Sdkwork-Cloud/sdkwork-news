...
This directory is the local SDKWork component contract for `sdkwork-news-storage-sqlx-rust`.

- Component root: `sdkwork-news/crates/sdkwork-news-storage-sqlx-rust`
