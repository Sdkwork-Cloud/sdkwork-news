# sdkwork-news-storage-sqlx-rust

Domain: drive
Capability: news-storage-sqlx
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-news-storage-sqlx-rust`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
