...
This README is the SDKWork module entrypoint for `sdkwork-content-news-repository-sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
