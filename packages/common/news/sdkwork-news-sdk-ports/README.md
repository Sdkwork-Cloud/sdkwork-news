...
Domain: content
Capability: news-sdk-ports
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/news-sdk-ports`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
