...
This directory is the local SDKWork component contract for `@sdkwork/news-pc-react`.

- Component root: `sdkwork-news/apps/sdkwork-news-pc/packages/news/sdkwork-news-pc-react`
