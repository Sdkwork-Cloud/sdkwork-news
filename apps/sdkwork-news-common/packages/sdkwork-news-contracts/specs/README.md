...
This directory is the local SDKWork component contract for `@sdkwork/news-contracts`.

- Component root: `sdkwork-news/apps/sdkwork-news-common/packages/sdkwork-news-contracts`
