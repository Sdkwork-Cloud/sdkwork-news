...
Domain: content
Capability: news-service
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/news-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
