...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_news_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'news_', owner: 'news-platform', domain: 'news' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into news database contract\n`);
