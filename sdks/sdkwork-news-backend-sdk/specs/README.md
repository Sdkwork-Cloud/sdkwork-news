...
This directory is the local SDKWork component contract for `@sdkwork/news-backend-sdk-workspace`.

- Component root: `sdkwork-news/sdks/sdkwork-news-backend-sdk`
