# @sdkwork/news-backend-sdk-workspace

Domain: content
Capability: news-backend-sdk-workspace
Package type: sdk-family
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/news-backend-sdk-workspace`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
