# @sdkwork/news-app-sdk-workspace

Domain: content
Capability: news-app-sdk-workspace
Package type: sdk-family
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/news-app-sdk-workspace`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
